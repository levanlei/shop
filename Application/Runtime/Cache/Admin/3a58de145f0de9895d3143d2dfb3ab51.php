    ...
    <div class="shop_all">
        <div class="row">
            <div class="col-md-2 shop_one">
                    <?php if(is_array($shop_one_info)): foreach($shop_one_info as $key=>$v): ?><a data-id="<?php echo ($v["id"]); ?>" data-lv="1" href="javascript:void(0);">
                            <p ><?php echo ($v["name"]); ?></p>
    ...
    <script>
        $(function () {
            $(document).on("click",".shop_all a",function () {
                ...
                $.ajax({
                    url:"<?php echo U('Admin/Index/get_shop_lx');?>",
                    dataType:"json",
                    async:true,
                    data:{id:id,lv:lv},
                    type: "post",
            ...
            $(document).on("click",".add_cla_ok",(function () {
                ...
                $.ajax({
                    url:"<?php echo U('Admin/Index/add_cla_ok');?>",
                    dataType:"json",
                    async:true,
