    ...
    <script>
        $(function () {
            ...
            $(document).on("click",".shop_brand",function () {
                ...
                $.ajax({
                    url:"<?php echo U('Admin/Cate/get_shop_cate_list');?>",
                    dataType:"",
                    async:true,
            ...
            $(document).on("click",".del_att",function () {
                ...
                if (r==true)
                {
                    ...
                    var _this = $(this);
                    $.post("<?php echo U('Admin/Cate/del_att');?>",{id:id},function (data) {
                        if(data == 1){
            ...
            $(document).on("click",".add_att",function () {
                ...
                var _this = $(this);
                $.post("<?php echo U('Admin/Cate/add_att');?>",{id:id,name:name},function (data) {
                    if(data == 1){
            ...
            $(document).on("blur",".edit_att_name",function () {
                ...
                $.post("<?php echo U('Admin/Cate/edit_att_name');?>",{id:id,name:name},function (data) {
                    console.log(data);
                    if(data == 1){
                        toast_success("修改成功");
                        return;
            ...
            $(document).on("click",".del_this_type",function () {
                ...
                if (r==true)
                {
                    var _this = $(this);
                    var id = $(this).attr("data-id");
                    $.post("<?php echo U('Admin/Cate/del_this_type');?>",{id:id},function (data) {
                        if(data == 1){
            ...
            $(document).on("click",".add_new_type",function () {
                ...
                $.post("<?php echo U('Admin/Cate/add_new_type');?>",{id:id,name:name},function (data) {
                    $("input[name='shop_brand_val']:checked").click();
                });
            });
            ...
            $(document).on("click",".del_this_all",function () {
                ...
                if (r==true)
                {
                    var _this = $(this);
                    var id = $(this).attr("data-id");
                    $.post("<?php echo U('Admin/Cate/del_this_all');?>",{id:id},function (data) {
                        if(data == 1){
                            _this.parent().parent().fadeOut(300);
                            toast_success("删除成功");
                            return;
            ...
            $(document).on("click",".add_new_shop_type",function () {
                ...
                $.post("<?php echo U('Admin/Cate/add_new_shop_type');?>",{v:v,pid_type:pid_type,pid:pid},function (data) {
                    if(data){
                        toast_success("新增成功");
                        $("input[name='shop_brand_val']:checked").click();
                    }
